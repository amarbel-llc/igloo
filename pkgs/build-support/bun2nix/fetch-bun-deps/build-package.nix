# Build a bun package for the dependency cache.
#
# If the package is a tarball, extract it, otherwise make a copy of the
# directory in $out/share/bun-packages.
#
...
let
  bunWithNode = import ./bun-with-node.nix { inherit pkgs lib bun; } args;
