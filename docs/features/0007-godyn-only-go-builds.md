...
| Package graph | committed graph, regenerated by hand | derived at eval time from a nix manifest, nothing committed (FDR 0008); a drift check covers the interim (igloo#72) |
